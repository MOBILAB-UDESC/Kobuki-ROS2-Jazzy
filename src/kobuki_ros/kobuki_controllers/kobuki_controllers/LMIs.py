...
class LMIsNode(Node):
    def __init__(self ,dt = 0.08, trajectory = "infinite"):
        ...
        self.Q = np.zeros((3, 3))
        self.Y = np.zeros((2, 3))
        self.name  = "/home/nilton/Desktop/Ros2/"+"LMIsDEs_"+self.region+"_0-25.png"
        self.route = "/home/nilton/Desktop/Ros2/LMIsDEs"+self.region+"_0-25"
    ...
    def LMIsCallback(self, msg):
        try:
            ...
            K, Y, Q = self.eng.LMIsDEs(A_matlab, B_matlab, self.region, self.Q, self.Y, nargout=3)
            ...
            # To avoid the first 10 iterations due to the large cost
            if (self.aux > 10):
                v = u[0]
                w = -u[1]
