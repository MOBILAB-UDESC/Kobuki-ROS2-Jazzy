...
class LMIsResNode(Node):
    def __init__(self ,dt = 0.08, trajectory = "infinite"):
        super().__init__("LMIsResNode")
        ...
        self.Q = np.zeros((3, 3))
        self.Y = np.zeros((2, 3))
        self.name  = "/home/nilton/Desktop/Ros2/"+"LMIsResC_V-"+str(self.vmax)+"_W-"+str(self.wmax)+".png"
        self.route = "/home/nilton/Desktop/Ros2/LMIsResC_V-"+str(self.vmax)+"_W-"+str(self.wmax)+""
    ...
    def LMIsCallback(self, msg):
        try:
            ...
            K, Y, Q = self.eng.LMIsRest(A_matlab, B_matlab, x_matlab, self.vmax, self.wmax, self.Q, self.Y, nargout=3)
